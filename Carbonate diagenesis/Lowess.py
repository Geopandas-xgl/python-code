...
data = xlrd.open_workbook("C:\\Users\\19328\\Desktop\\西交测样\\成岩模拟\\chen_2018_GCA\\Clino_U.xlsx")
sheet = data.sheet_by_name("Sheet3")
x_values = sheet.col_values(1)
y_values = sheet.col_values(2)
...
evalDF = loess("Xvalue", "Yvalue", data = df, alpha=0.6, poly_degree=2)
